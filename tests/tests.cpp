...
class AStarTests : public ::testing::Test {
protected:
    GIS gis;
...
public:
    AStarTests() : gis(GISProvider::getGIS()), navGis(gis), navigation(navGis), validator(gis) {
    }
 ...
 */
TEST_F(AStarTests, oppositeRoutesByDistance) {
 ...
 * Routes should be the same but reveres
 */
TEST_F(AStarTests, oppositeRoutesByTime) {
    Coordinates from(Longitude(32.113357), Latitude(34.801290)); // J1001
    Coordinates to(Longitude(32.11265), Latitude(34.79254)); // J1014
    auto routes = navigation.getRoutes(from, to);
 ...
 */
TEST_F(AStarTests, highwayTooFar) {
...
TEST_F(AStarTests, differentRoutes) {
    Coordinates origin(Longitude(32.50365),
 ...
 */
TEST_F(AStarTests, differentRoutesOpposite) {
 ...
 */
TEST_F(AStarTests, invalidRoutesUnreachable) {
 ...
 */
TEST_F(AStarTests, unidirectionalSingleWayInvalid) {
 ...
 */
TEST_F(AStarTests, bidirectionalSingleWay) {
 ...
 */
TEST_F(AStarTests, singleSlowWayVsFastWay) {
 ...
 */
TEST_F(AStarTests, finalBidirectionalWay) {
 ...
 */
TEST_F(AStarTests, parallelRoutes) {
 ...
 */
TEST_F(AStarTests, minimalWaysRoute) {
...
TEST_F(AStarTests, BasicPathTest) {
    GIS gis;
...
TEST_F(AStarTests, WrongPathsAppearCloserToTarget) {
    GIS gis;
...
TEST_F(AStarTests, InvalidRouteLastWayHighway) {
    GIS gis;
...
TEST_F(AStarTests, HighwayFurtherThanThreeMeters) {
    GIS gis;
...
TEST_F(AStarTests, HighwayWithinThreeMeters) {
    GIS gis;
    gis.loadMapFile("astar3b.json");
    NavigationGIS navigationGis(gis);
    Navigation navigation(navigationGis);
