...
struct Meters: NamedTypeDouble<meters_precision> { using NamedTypeDouble<meters_precision>::NamedTypeDouble; };
...
public:
    Coordinates(Longitude longitude, Latitude latitude) : _longitude(trimLongitude(longitude)), _latitude(latitude) {}
