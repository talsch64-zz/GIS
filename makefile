...
SRCS := $(wildcard ./GIS_315524694.cpp ./Logger.cpp ./main.cpp ./Restrictions.cpp ./Utils.cpp ./entities/*.cpp ./entities/geometry/*.cpp ./entities/JsonHandlers/Serializers/*.cpp ./entities/JsonHandlers/parsers/*.cpp ./search/*.cpp ./bonus.avoid_tolls/*.cpp ./tests/*.cpp ./navigation/*.cpp)
DEPS := $(OBJS:.o=.d)
BUILD_DIR := build
