...
SRCS := $(wildcard ./*.cpp ./entities/*.cpp ./entities/geometry/*.cpp ./entities/JsonHandlers/Serializers/*.cpp ./entities/JsonHandlers/parsers/*.cpp ./search/*.cpp ./bonus.error_handling/*.cpp ./tests/*.cpp ./navigation/*.cpp)
DEPS := $(OBJS:.o=.d)
BUILD_DIR := build
